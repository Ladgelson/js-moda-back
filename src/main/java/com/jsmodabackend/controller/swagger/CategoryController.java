...
public interface CategoryController {
    ...
    @Operation(description = "Find all categories paginated")
    @ApiResponses(value = {
    ...
    @Operation(description = "Save a valid category")
    @ApiResponses(value = {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "500", description = "Internal server error", content = @Content)})
    @PutMapping("/{id}")
    ResponseEntity<CategoryDTO> update(@RequestBody CategoryDTO categoryDTO, @PathVariable Integer id);
